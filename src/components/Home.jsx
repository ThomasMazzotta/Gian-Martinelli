    ...
    <section className="min-h-screen w-full overflow-x-hidden ">
      <div className="min-h-screen flex flex-col">
        <div className="relative">
          {" MAIN IMAGE"}
          <img src={mainImage} className="block w-full" alt="Gian Martinelli" />
          <img
            src={aboutGian}
            className="pointer-events-none absolute left-[-35%] -bottom-[10%] z-0 w-[135%] max-w-none rotate-8"
            alt=""
          />
        </div>
        {" DESCRIPTION"}
        <div className="px-4 pt-10">
          <p className="w-90 text-[1.4rem] leading-relaxed text-palette-white">
            Gian Martinelli, a Trentino-born actor, blends martial arts and international training to bring authentic
            characters to life.
          </p>
        </div>
        {" NAVIGATION AND SVGs"}
        <div className="relative  flex items-end justify-between px-4 py-0 text-white mt-auto mb-4">
          <div className="flex flex-col text-2xl justify-center  ">
            <img
              src={talk}
              className="pointer-events-none absolute -right-[65%] -top-[75%] z-0 w-[135%] max-w-none -rotate-8"
              alt=""
            />
            <p>projects</p>
            <p>gallery</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-15 w-15">
              <path
